...
Comprehensive performance optimization guide for React applications, designed for AI agents and LLMs. Contains rules across multiple categories, prioritized by impact from critical (eliminating waterfalls, reducing bundle size) to incremental (advanced patterns). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations, and specific impact metrics to guide automated refactoring and code generation.
...
2. [Bundle Size Optimization](#2-bundle-size-optimization) — **CRITICAL**
   ...
   - 2.4 [Prefer Statically Analyzable Paths](#24-prefer-statically-analyzable-paths)
...
### 2.4 Prefer Statically Analyzable Paths
